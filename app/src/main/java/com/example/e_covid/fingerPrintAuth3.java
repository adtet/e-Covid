...
public class fingerPrintAuth3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finger_print_auth3);
        notifikasi = findViewById(R.id.notif_finger_print_auth3);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            if(!fingerprintManager.isHardwareDetected()){
                ...
                if (chiperInit()){
                    ...
                    fingerPrintHandler3 fingerprintHandler = new fingerPrintHandler3(this);
