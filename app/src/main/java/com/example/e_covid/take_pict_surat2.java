...
public class take_pict_surat2 extends AppCompatActivity {
    File photofile = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_take_pict_surat2);
        imageView = findViewById(R.id.imageShowSuratSakit);
        capture  = findViewById(R.id.btnCaptureSuratSakit);
        ...
        capture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final sakitPost sakitPost = new sakitPost(id,matakuliah,dosen);
                ...
                Call<sakitPost>call = jsonPlaceHolder.getSakitPost(sakitPost);
                call.enqueue(new Callback<com.example.e_covid.sakitPost>() {
                    @Override
                    public void onResponse(Call<com.example.e_covid.sakitPost> call, Response<com.example.e_covid.sakitPost> response) {
                        sakitPost sakitPost1 = response.body();
                        String pesan = sakitPost1.getSakit();
                    ...
                    @Override
                    public void onFailure(Call<com.example.e_covid.sakitPost> call, Throwable t) {
    ...
    private File createImageFile() throws IOException {
        ...
        String imageFileName = "Surat_sakit_"+id+"_"+"_"+matakuliah+"_"+dosen+"_"+timeStamp+"_";
    ...
    private void upload_gambar(String b){
