...
public class fingerPrintHandler4 extends FingerprintManager.AuthenticationCallback {
    private Context context;
    private DatabaseHelper db;
    private String url = "http://156.67.221.101:4000/";

    public fingerPrintHandler4(Context context){
    ...
    public void onAuthenticationError(int errorCode, CharSequence errString) {
        ...
        this.notif("Terdapat error autentikasi : "+errString);
    ...
    private void notif(String s){
        TextView label = (TextView)((Activity)context).findViewById(R.id.notif2_finger_print_auth4);
        label.setText(s);
    }
    private void launch(){
        this.context.startActivity(new Intent(this.context,showJadwal4.class));
    }
            ...
            call.enqueue(new Callback<List<jadwalGet>>() {
                ...
                public void onResponse(Call<List<jadwalGet>> call, Response<List<jadwalGet>> response) {
                    ...
                    if (jadwalGets.isEmpty()){
                        ...
                        ((fingerPrintauth4)context).finish();
                    }
                    else{
