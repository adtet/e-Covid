...
public class showJadwal4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_jadwal4);
        ...
        adapter = new RecyclerViewAdapter5(timestartList,timeendList,matakuliahList,dosenList,this);
